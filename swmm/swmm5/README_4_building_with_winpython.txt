Using winpython 
*Obviously download and install winpython. 
* Add a file distutils.cfg to \python-2.7.x.amd64\Lib with content
[build]
compiler = mingw32

Then open command prompt using "WinPython Command Prompt.exe"
